...
public class ClienteUDP extends Thread {
  ...
  private String ipServidor = Usuario.ipServidor;
  ...
  public void processarMensagem(String mensagemRecebida) {
    ...
    Platform.runLater(() -> {
      ControllerChat.getControllerChat().exibirMensagens();
      ControllerGrupos.getControllerGrupos().listarGruposDoUsuario(Usuario.grupos);
    });
