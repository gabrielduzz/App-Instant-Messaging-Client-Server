...
public class ControllerChat implements Initializable {
  ...
  public static ControllerChat getControllerChat() {
  ...
  void enviar(MouseEvent event) {
    ...
    Usuario.clienteUDP = new ClienteUDP();
  ...
  void sair(MouseEvent event) {
    ...
    Usuario.clienteTCP.setMensagemAPDU(new MensagemAPDU("LEAVE", nomeGrupo, Usuario.nome));
